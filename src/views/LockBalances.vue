        ...
        <section class="section section-skew">
            <div class="row">
                <div class="col-md-12" style="padding:80px 80px 20px;min-height:400px">
                    <div class="row p-1">
                        <h3 class="col-md-6 mb-0">Lock Balances ({{searchItems.length}})</h3>
...
export default {
    ...
    computed: {
        ...mapGetters({
        items: 'blockchain/lockbalances',
        fetching: 'blockchain/fetchingLockBalances',
        })
    },
    mounted() {
        this.fetchLockBalances();
    },
    methods: {
        ...mapActions({
        fetchLockBalances: 'blockchain/fetchLockBalances'
        })
    },
